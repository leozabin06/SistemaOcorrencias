...
public class OcorrenciaRepositorioMySQL implements IOcorrenciaRepositorio {

    private final DepartamentoRepositorioMySQL deptoRepo   = new DepartamentoRepositorioMySQL();
    private final FuncionarioRepositorioMySQL  funcRepo    = new FuncionarioRepositorioMySQL();
