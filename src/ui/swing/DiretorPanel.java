...
public class DiretorPanel extends JPanel {
    ...
    public DiretorPanel(MainFrame frame, IDiretorService service, String nomeDiretor) {
        this.frame       = frame;
    ...
    private JPanel abaDepto() {
        ...
        MainFrame.estilizarTabela(tabela, MainFrame.COR_CABECALHO);
        ...
        JButton btnNovo    = MainFrame.botao("+ Novo Departamento", MainFrame.COR_BOTAO_AZUL);
    ...
    private void editarDepto(JTable t) {
        ...
        } catch (ValidacaoException | RuntimeException ex) {
            erro(ex.getMessage());
        }
    }
    ...
    private JPanel abaGerente() {
        ...
        JPanel barra = new JPanel(new FlowLayout(FlowLayout.LEFT, 8, 8));
        barra.setBackground(MainFrame.COR_FUNDO);
        JButton btnNovo    = MainFrame.botao("+ Novo Gerente",    MainFrame.COR_BOTAO_AZUL);
        JButton btnEditar  = MainFrame.botao("Editar Selecionado", MainFrame.COR_BOTAO_VERDE);
        JButton btnRefresh = MainFrame.botao("Atualizar",          MainFrame.COR_BOTAO_CINZA);
