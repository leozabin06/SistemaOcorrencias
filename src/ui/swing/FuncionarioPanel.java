...
public class FuncionarioPanel extends JPanel {
    ...
    public FuncionarioPanel(MainFrame frame, IFuncionarioService service, Funcionario funcionario) {
        this.frame       = frame;
    ...
    private JPanel corpo() {
        ...
        lblTitulo.setForeground(MainFrame.COR_TEXTO);
        ...
        MainFrame.estilizarTabela(tabela, COR_F);
    ...
    private JPanel barra() {
        ...
        p.setBorder(BorderFactory.createCompoundBorder(
            BorderFactory.createMatteBorder(1, 0, 0, 0, MainFrame.COR_BORDA),
            new EmptyBorder(4, 8, 4, 8)
        ));

        JButton btnStatus  = MainFrame.botao("Alterar Meu Status Temporario", COR_F);
        JButton btnRefresh = MainFrame.botao("Atualizar Lista", MainFrame.COR_BOTAO_CINZA);
