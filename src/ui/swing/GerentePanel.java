...
public class GerentePanel extends JPanel {
    ...
    public GerentePanel(MainFrame frame, IGerenteService service, Gerente gerente) {
        this.frame   = frame;
    ...
    private JPanel cabecalho() {
        ...
        JButton sair = MainFrame.botao("Sair", MainFrame.COR_BOTAO_VERM);
    ...
    private JPanel abaFunc() {
        ...
        p.setBackground(MainFrame.COR_FUNDO);
        ...
        MainFrame.estilizarTabela(tabela, COR_G);
        carregarFunc();

        JPanel barra = new JPanel(new FlowLayout(FlowLayout.LEFT, 8, 8));
        barra.setBackground(MainFrame.COR_FUNDO);
        JButton btnNovo    = MainFrame.botao("+ Novo Funcionario",  MainFrame.COR_BOTAO_AZUL);
        JButton btnEditar  = MainFrame.botao("Editar Selecionado",  MainFrame.COR_BOTAO_VERDE);
        JButton btnRefresh = MainFrame.botao("Atualizar",           MainFrame.COR_BOTAO_CINZA);
    ...
    private JPanel abaOcorr() {
        ...
        JPanel barra = new JPanel(new FlowLayout(FlowLayout.LEFT, 8, 8));
        barra.setBackground(MainFrame.COR_FUNDO);
        JButton btnReg    = MainFrame.botao("+ Registrar",        MainFrame.COR_BOTAO_AZUL);
        JButton btnAlt    = MainFrame.botao("Alterar",            MainFrame.COR_BOTAO_VERDE);
        JButton btnEnc    = MainFrame.botao("Alterar Status Def.",new Color(140, 80, 0));
        JButton btnRefresh= MainFrame.botao("Atualizar",          MainFrame.COR_BOTAO_CINZA);
